      ...
      <div className="h-full flex flex-col">
        <div className="bg-yellow-50 border-b border-yellow-200 p-4">
          <div className="flex items-center gap-2 text-yellow-800">
            ...
            <Button size="sm" variant="bordered" onPress={() => window.location.reload()} className="ml-auto">
              Try Reload
            </Button>
          </div>
        </div>
        ...
        <div className="bg-white border-b p-4 flex gap-2 items-center">
          ...
          <Button onPress={saveFallbackTemplate} startContent={<Save className="w-4 h-4" />}>
            Save Template
          </Button>
          <Button onPress={downloadTemplate} variant="bordered" startContent={<Download className="w-4 h-4" />}>
            Download HTML
          </Button>
          <Button onPress={copyToClipboard} variant="bordered" startContent={<Copy className="w-4 h-4" />}>
            Copy HTML
          </Button>
        </div>
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="bg-white border-b p-4 flex gap-2 items-center flex-wrap">
        ...
        <Button onPress={saveTemplate} startContent={<Save className="w-4 h-4" />}>
          Save Template
        </Button>
        <Button onPress={downloadTemplate} variant="bordered" startContent={<Download className="w-4 h-4" />}>
          Download HTML
        ...
        <Button
          ...
          variant="bordered"
          startContent={showCode ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
        >
          {showCode ? "Hide Code" : "Show Code"}
        </Button>
        <Button onPress={updateEditorContent} variant="bordered" startContent={<RefreshCw className="w-4 h-4" />}>
          Refresh Template
        </Button>
        <Button onPress={saveAsCustomTemplate} variant="bordered" startContent={<Plus className="w-4 h-4" />}>
          Save as Custom
        </Button>
      </div>
          ...
          {!showCode ? (
            ...
            <div className="flex-1 p-4">
              <Card className="h-full">
                <CardHeader>
                  <h3 className="text-lg font-semibold">Generated Email HTML with Inline CSS</h3>
