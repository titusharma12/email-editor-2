...
export function TemplatePreview() {
  ...
  return (
    <div className="h-full bg-gray-100 p-6">
          ...
          {templates.map((template) => (
            <Card
              ...
              className={`cursor-pointer transition-all ${
                currentTemplate === template.id ? "ring-2 ring-primary shadow-lg" : ""
              }`}
              onPress={() => setCurrentTemplate(template.id)}
            >
      ...
      <Card className="mt-6">
        <CardHeader>
          <h3 className="text-lg font-semibold">Current Template Data</h3>
